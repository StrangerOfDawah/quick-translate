...
Выделение только на русском игнорируется без открытия карточки и запроса к API. Если в одном выделении смешаны русский, английский, арабский или другие языки, русские фрагменты остаются без изменений, а остальные переводятся и показываются отдельными секциями с названием исходного языка.
